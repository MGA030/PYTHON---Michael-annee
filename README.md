...
```
![output_11_0](https://github.com/MGA030/PYTHON---Michael-annee/assets/134095872/f65201c7-6b6f-439c-88e0-feb1a9d7ae4d)
...
```
    ...
    inlfam_001 weight in kilograms: 60.3
...
def fahr_to_celsius(temp):
    ...
    # a new variable. this code does sanme thing as previus function but is more 
    # explicit in explaing how return command works.
    return ((temp - 32) * (5/9))
```
...
```
    ...
    <ipython-input-13-eed2471d229b> in <module>
...
```python
'freezing point of water innKelvin:'
...
def detect_problems(filename):
    ...
    if numpy.amax(data, axis = 0)[0] == 0 and numpy.amax(data, axis=0)[20] == 20:
        print("Suspicious looing maxima!")
...
```python
def offset_mean(data, rarget_mean_value):
...
```
    ...
    offset_mean(data, rarget_mean_value)
        Return a new array containing the original data with its mean offset to match the desired value
...
```
    ...
    <ipython-input-10-4c62383913f7> in <module>
          2 total = 0.0
...
```
    ...
    <ipython-input-22-f9d109085db1> in <module>
    ----> 1 print(normalize_rectangle( (0.0, 1.0, 2.0) ))
    

    <ipython-input-21-7a0d8b02b070> in normalize_rectangle(rect)
...
```
    ...
    <ipython-input-23-f7e0d48bdfd0> in <module>
